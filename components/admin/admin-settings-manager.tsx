...
function actionLabel(value: string) { return ({ "auth.login": "로그인", "auth.password.recover": "비밀번호 재설정", "employee.register": "직원 가입 신청", "employee.profile.update": "프로필 수정", "admin.employee.create": "직원 직접 등록", "admin.employee.update": "직원 정보 수정", "admin.employee.password.reset": "직원 비밀번호 재설정", "admin.employee.approve": "직원 가입 승인", "admin.employee.reject": "직원 가입 반려", "admin.employee.suspend": "직원 사용 중지", "admin.employee.activate": "직원 사용 재개", "admin.holiday.create": "회사 휴무일 등록", "admin.holiday.update": "회사 휴무일 수정", "admin.holiday.delete": "회사 휴무일 삭제", "admin.sessions.cleanup": "만료 세션 정리", "admin.login.unlock": "로그인 잠금 해제", "admin.storage.delete": "Storage 파일 삭제", "admin.settings.update": "운영 설정 변경", "task.create": "업무 등록", "task.update": "업무 수정", "task.schedule.update": "캘린더에서 업무 일정 변경", "task.delete": "업무 삭제", "leave.create": "휴가 신청", "leave.update": "휴가 수정", "leave.cancel": "휴가 취소", "leave.delete": "휴가 삭제", "leave.review": "휴가 승인 처리" } as Record<string, string>)[value] ?? value; }
